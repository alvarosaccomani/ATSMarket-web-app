...
import { ProductInterface } from '@interfaces/product.interface'; // Importamos la interfaz del producto
import { Observable, of } from 'rxjs'; // Usamos RxJS para simular llamadas asíncronas
...
export class ProductsService {
  ...
  private productsData: ProductInterface[] = [
    {
      id: 1,
      nombre: "Abanico",
      precio: 3000
   ...
   * @returns Observable de un array de productos.
   */
  public getFeaturedProducts(count: number = 4): Observable<ProductInterface[]> {
